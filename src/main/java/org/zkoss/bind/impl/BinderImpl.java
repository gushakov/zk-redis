...
public class BinderImpl implements Binder, BinderCtrl, Serializable {
	...
	private void init(boolean isDeserialization) {
		...
		// gushakov, https://potix.freshdesk.com/support/tickets/6742
		// do not try to access current session during de-serialization
